    ...
    return (
        <div className={styles.gameOver}>
            ...
            <Form className="inputForm" onSubmit={handleSubmit}>
                <Form.Label htmlFor="initialInput">Your initials: </Form.Label>
                <Form.Control id="initialInput" className="nameInput" type="text" placeholder="AAA" onChange={(e) => setInput(e.target.value)} maxLength={3}/>
                <Form.Text>
